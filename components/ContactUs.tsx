          ...
          <div className="flex w-full xl:w-7/12">
            ...
            <form className="border-1 flex w-full flex-col rounded-lg border border-gray-200 bg-white px-8 py-8 shadow-xl sm:px-16">
              ...
              <textarea
                name="message"
                placeholder="Message"
                className="border-1 mb-4 h-36 rounded-lg border border-gray-200 py-3 px-4 shadow"
              ></textarea>
              <div className="flex flex-row items-center justify-start">
                <Link href={''}>
                  <a className="w-full rounded-lg border bg-dark-blue py-4 text-center text-2xl font-semibold text-white">
                    SEND
                  </a>
                </Link>
              </div>
